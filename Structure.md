...
Add migration:  
dotnet ef migrations add UserAccountMemberupdate --project TLearn.Infrastructure --startup-project TLearn.API --output-dir TLearn.Infrastructure/Data/Migrations
