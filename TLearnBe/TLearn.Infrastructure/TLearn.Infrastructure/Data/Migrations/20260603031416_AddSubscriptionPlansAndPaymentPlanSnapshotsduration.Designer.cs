...
namespace TLearn.Infrastructure.TLearn.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260603031416_AddSubscriptionPlansAndPaymentPlanSnapshotsduration")]
    partial class AddSubscriptionPlansAndPaymentPlanSnapshotsduration
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TLearn.Domain.Entities.AiUsageLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TLearn.Domain.Entities.Payment", b =>
                {
                    ...
                    b.Property<string>("LastPayOSStatus")
                        .HasMaxLength(100)
                    ...
                    b.Property<int>("WebhookReceivedCount")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TLearn.Domain.Entities.SubjectInvitation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("SubjectInvitations");
                });

            modelBuilder.Entity("TLearn.Domain.Entities.SubjectMember", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TLearn.Domain.Entities.SubscriptionPlan", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TLearn.Domain.Entities.UserFlashcardProgress", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("TLearn.Domain.Entities.Flashcard", b =>
                {
                    b.HasOne("TLearn.Domain.Entities.User", "CreatedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("TLearn.Domain.Entities.SubjectInvitation", b =>
                {
                    b.HasOne("TLearn.Domain.Entities.User", "Inviter")
                        .WithMany()
            ...
            modelBuilder.Entity("TLearn.Domain.Entities.SubjectMember", b =>
                {
                    b.HasOne("TLearn.Domain.Entities.User", "DeletedByUser")
                        .WithMany()
